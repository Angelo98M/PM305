...
public class MeleeAttack extends DamageProjectileSkill {
    ...
    /**
     * Constructor for the MeeleAttack @Param animationPath for the standard animationPath @Param
     * speed for the speed of the Attack @Param dmg for the Damage the attack does @Param size for
     * the Size of the Sword @Param targetting the ITargetSelection @Param range is the Range the
     * attack travels.
     */
    public MeleeAttack() {
    ...
    public void execute(Entity entity) {
        ...
        Point targetPoint =
                SkillTools.calculateLastPositionInRange(epc.getPosition(), aimedOn, range);
                                        ...
                                        pc -> {
                                            if (b.getClass()
                                                ...
                                                ((PositionComponent) pc)
                                                        .setPosition(getKnockbackCoordinate(now));
                                            }
                                        });
                    }
                };
